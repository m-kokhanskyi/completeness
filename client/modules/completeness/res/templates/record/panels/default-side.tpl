...
{{/if}}
{{#if complete}}
<div class="cell form-group col-sm-6 col-md-12" data-name="complete">
    <label class="control-label" data-name="complete"><span class="label-text">{{translate 'Complete' scope='EntityManager' category='labels'}}</span></label>
    <div class="field" data-name="complete">
        {{{complete}}}
    </div>
</div>
{{/if}}
